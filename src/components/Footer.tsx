...
const Footer = () => {
  return (
    <footer className="block 2lg:max-w-[1250px] mx-6 2lg:mx-auto mt-72 px-4 lg:px-[75px] mb-12">
      <div className="relative w-full bg-secondary rounded-2xl pt-7 pb-4 px-9 shadow-5xl flex flex-col 2lg:flex-row items-start">
        <div>
        ...
        <div className="2lg:mr-24 w-44 mt-8 2lg:mt-0">
          <FooterLinks />
        </div>
